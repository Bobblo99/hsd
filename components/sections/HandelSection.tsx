...
import { ShoppingCart, Mail, MessageCircle, Truck, Shield, Star } from 'lucide-react';
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        .fromTo(content.children,
          ...
          { y: 0, opacity: 1, scale: 1, duration: 0.7, stagger: 0.1, ease: "power3.out" }, "-=0.5"
        );
      }
    });
        ...
        ScrollTrigger.create({
          ...
          onEnter: () => {
            gsap.fromTo(card,
              ...
              { y: 0, opacity: 1, scale: 1, duration: 0.6, delay: index * 0.1, ease: "power3.out" }
            );
          }
        });
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div ref={contentRef} className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="space-y-8">
            <p className="text-xl text-gray-300 leading-relaxed">
              Wir bieten Ihnen eine umfassende Auswahl an hochwertigen Felgen und Reifen. 
              Ob Neuwaren oder geprüfte Gebrauchtware – bei uns finden Sie die perfekte 
              Lösung für Ihr Fahrzeug.
            </p>
            
            <p className="text-lg text-gray-400 leading-relaxed">
              Unser Sortiment umfasst Premium-Marken und preiswerte Alternativen. 
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              features: ["Fachberatung", "Individuelle Angebote", "Schnelle Abwicklung"]
            }
          ].map((service, index) => (
            <div
              key={service.title}
